...
class AIMemeGeneratorServiceStub(object):
...
def add_AIMemeGeneratorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'servicepb.AIMemeGeneratorService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('servicepb.AIMemeGeneratorService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class AIMemeGeneratorService(object):
    """Missing associated documentation comment in .proto file."""
