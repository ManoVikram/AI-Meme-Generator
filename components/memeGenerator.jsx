    ...
    return (
        <section className='flex flex-col flex-1 justify-start items-center h-full w-full gap-10 py-10'>
            ...
            <div className="flex flex-col justify-between items-center w-2/3 bg-white rounded-xl px-4 py-3 gap-4">
                <input type="text" placeholder='Drop your meme topic' className='w-full ring-0 outline-0' />

                <button className='flex justify-between items-center gap-1 bg-black rounded-full text-white px-4 py-2 w-fit -mb-7 cursor-pointer'>
